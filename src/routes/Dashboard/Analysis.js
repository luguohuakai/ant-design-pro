...
@connect(({chart, analysis, loading}) => ({
    chart,
    analysis,
    fetchAnalysisDataLoading: loading.effects['analysis/fetchAnalysisData'],
}))
export default class Analysis extends Component {
    ...
    render() {
        const {analysis, fetchAnalysisDataLoading} = this.props;
            ...
            <Fragment>
                <Row gutter={24}>
                    <Col {...topColResponsiveProps}>
                        <ChartCard
                            loading={fetchAnalysisDataLoading}
                            bordered={false}
                            title="用户总数"
                            action={
                                <Tooltip title="指标说明">
                  ...
                  {`${numeral(yesterday_total).format('0,0')}`}
                    ...
                    <Col {...topColResponsiveProps}>
                        <ChartCard
                            ...
                            footer={
                                <Field label="昨日活跃用户" value={numeral(yesterday_active).format('0,0')}/>
                            }
                            contentHeight={46}
                        >
