...
import { Form, Input, Button, Card, Radio, Icon, Tooltip, Upload } from 'antd';
      ...
      <PageHeaderLayout title="学校添加" content="太棒了,又一所学校即将支持小程序认证。">
          ...
          <FormItem {...formItemLayout} label="搜索">
            {getFieldDecorator('name')(
              <iframe
                ...
                height="500px"
                frameBorder="0"
                src="https://apis.map.qq.com/tools/locpicker?search=1&type=1&key=SNCBZ-IAIKX-VD74W-ZBGFH-DBNSQ-UXBE2&referer=myapp"
              />
            )}
          </FormItem>
        </Card>
        <Card bordered={false}>
          <Form onSubmit={this.handleSubmit} hideRequiredMark style={{ marginTop: 8 }}>
            ...
            <FormItem {...formItemLayout} label="是否多运营商">
              <div>
                {getFieldDecorator('is_multiple_operators', {
                  initialValue: '0',
                })(
                  <Radio.Group>
                    <Radio value="1">是</Radio>
